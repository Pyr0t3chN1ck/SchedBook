import { Component, OnDestroy, ViewChild, Input, ElementRef, Optional, Self } from '@angular/core';
import { MatFormFieldControl } from '@angular/material/form-field';
import { ControlValueAccessor, FormGroup, FormBuilder, NgControl, Validators, AbstractControl } from '@angular/forms';
...
export class PhoneNumberInputComponent implements ControlValueAccessor, MatFormFieldControl<PhoneNumber>, OnDestroy {
  static nextId = 0;
